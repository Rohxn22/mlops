...
# S3 bucket name
bucket_name = 'mlops-dataset-792633646256-eu-north-1-an'
...
def main():
    ...
    if page == "Data Drift":
        ...
        if most_recent_folder:
            # Load the baseline CSV (train.csv)
            baseline_csv_key = 'datasets/train.csv'
        ...
        if most_recent_folder:
            ...
            if selected_file:
                ...
                latest_df = latest_df.drop(['Prediction'], axis=1, errors='ignore')
