...
@app.get("/health")
def health_check():
    from prediction_model.predict import load_model, MODEL_PATH

    # Check model file exists
    model_status = "OK" if os.path.exists(MODEL_PATH) else "Not found"

    # Check model actually loads and predicts
    try:
        load_model()
